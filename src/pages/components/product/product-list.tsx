...
const ProductListComponent = () => {
  return (
    <div>
      ...
      <div className="grid grid-cols-2 h-72 gap-x-2 overflow-y-scroll scroll-b  justify-center items-center w-full ">
        <div
          className="relative flex flex-col justify-between   bg-white shadow-md rounded-3xl  bg-cover text-gray-800  overflow-hidden cursor-pointer w-full object-cover object-center rounded-lg shadow-md h-36 my-2"
          style={{
            backgroundImage:
